...
import { calcMod } from '../../utils/character';
...
export const CharacterStatsPanel = ({
  ...
  const SKILLS_MAP: Record<string, string> = {
    ...
    'Arcanos': 'int', 'Historia': 'int', 'Investigaci�n': 'int', 'Naturaleza': 'int', 'Religi�n': 'int',
    'Trato con Animales': 'sab', 'Intuici�n': 'sab', 'Medicina': 'sab', 'Percepci�n': 'sab', 'Supervivencia': 'sab',
    'Enga�o': 'car', 'Intimidaci�n': 'car', 'Interpretaci�n': 'car', 'Persuasi�n': 'car'
  };
